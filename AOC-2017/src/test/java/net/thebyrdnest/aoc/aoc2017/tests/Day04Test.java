...
public class Day04Test {
    ...
    public void Example_1_1() throws Exception {
        ...
        Assertions.assertTrue(solver.isLegal1(phrase.split(" ")));
    }

    @Test
    public void Example_1_2() throws Exception {
        String phrase = "aa bb cc dd aa";
        Assertions.assertFalse(solver.isLegal1(phrase.split(" ")));
    }
    ...
    public void Example_2_1() throws Exception {
        ...
        Assertions.assertTrue(solver.isLegal2(phrase.split(" ")));
    }

    @Test
    public void Example_2_2() throws Exception {
    ...
    @Test
    public void Example_2_4() throws Exception {
        String phrase = "iiii oiii ooii oooi oooo";
        Assertions.assertTrue(solver.isLegal2(phrase.split(" ")));
    }

    @Test
    public void Example_2_5() throws Exception {
