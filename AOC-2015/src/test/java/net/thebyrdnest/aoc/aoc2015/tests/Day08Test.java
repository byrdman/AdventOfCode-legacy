...
import net.thebyrdnest.aoc.aoc2015.Day08;
...
public class Day08Test {
    ...
    @Test
    public void all_codeChars() {
        solver.countCharacters("\\\"\\\\\\x12");
        Assertions.assertEquals(8, solver.getCodeCount());
        Assertions.assertEquals(3, solver.getMemCount());
        Assertions.assertEquals(15, solver.getEncodingCount());
    }

    @Test
    public void emptyString_codeChars() {
        solver.countCharacters("\"\"");
        Assertions.assertEquals(2, solver.getCodeCount());
        Assertions.assertEquals(0, solver.getMemCount());
        Assertions.assertEquals(6, solver.getEncodingCount());
    }

    @Test
    public void abcString_codeChars() {
        solver.countCharacters("\"abc\"");
        Assertions.assertEquals(5, solver.getCodeCount());
        Assertions.assertEquals(3, solver.getMemCount());
        Assertions.assertEquals(9, solver.getEncodingCount());
    }

    @Test
    public void aaaString_codeChars() {
        solver.countCharacters("\"aaa\\\"aaa\"");
        Assertions.assertEquals(10, solver.getCodeCount());
        Assertions.assertEquals(7, solver.getMemCount());
        Assertions.assertEquals(16, solver.getEncodingCount());
    }
    ...
    public void problem1() {
        int iCodeCount = 0;
        int iMemCount = 0;
        int iEncodingCount = 0;
        for (String input : myInput.split("\n")) {
            solver.countCharacters(input);
            iCodeCount += solver.getCodeCount();
            iMemCount += solver.getMemCount();
            iEncodingCount += solver.getEncodingCount();
        }
